            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <div class="row row-cols-lg-2 g-4">
                        <div class="d-flex flex-column justify-content-center bg-light text-center p-2">
                            <c:if test = "${id != null}">
                                <div class="m-2">
                                    <img src="${avatar}" alt="Avatar of ${pseudo}" class="img-fluid ">
                                </div>
                            </c:if>
                            <div class="input-group m-2">
                                <span class="input-group-text" id="basic-addon5">Avatar</span>
                                <input type="file" class="form-control" aria-label="Avatar" aria-describedby="basic-addon5" name="avatar">
                            </div>
                        </div>
                        <div class="d-flex flex-column justify-content-center bg-light p-2">
                            <div class="input-group m-2">
                        ...
                        <div class="bg-light p-2">
                            ...
                            <div class="input-group m-2">
                                ...
                                <input type="date" class="form-control" aria-label="Birthdate" aria-describedby="basic-addon6" name="birthdate" value="${birthdate}">
                            </div>
                            <div class="input-group m-2">
